...
// s_start is the entry point of the kernel in supervisor mode.
...
int s_start(void) {
  ...
  // g_ufree_page[id] = USER_FREE_ADDRESS_START + id * PGSIZE;
  g_ufree_page[id] = USER_FREE_ADDRESS_START;
