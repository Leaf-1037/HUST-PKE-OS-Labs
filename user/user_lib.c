...
//
int sem_new(int val) {
  return do_user_call(SYS_user_sem_init, val, 0, 0, 0, 0, 0, 0);
}
...
//
int sem_P(int val) {
  return do_user_call(SYS_user_sem_P, val, 0, 0, 0, 0, 0, 0);
}
...
//
int sem_V(int val) {
  return do_user_call(SYS_user_sem_V, val, 0, 0, 0, 0, 0, 0);
}
